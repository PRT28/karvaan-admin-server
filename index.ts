...
import limitlessRoutes from './routes/limitless';
...
app.use('/limitless', checkKarvaanToken, limitlessRoutes);
...
app.use('/payments', checkKarvaanToken, paymentRoutes);
app.use('/bank', checkKarvaanToken, bankRoutes);
